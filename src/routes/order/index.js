...
const {schemas:{orderSchema}} = require('../../utils');
const {orderController:{createOrder, getAllOrders, getMonthlyIncome, updateOrder, daleteOrder,getUserOrders}} = require('../../controllers');

router.post('/', authUserMiddleWare,validateDto(orderSchema), createOrder);
